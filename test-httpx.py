...
proxies1 = httpx.Proxy(url='http://127.0.0.1:3129', auth=('abcd', 'abcd'), headers={
    'proxy': '127.0.0.1:5566'
})
proxies2 = httpx.Proxy(url='http://127.0.0.1:3355', auth=('abcd', 'abcd'), headers={
...
session = httpx.Client(http2=False, headers=None, verify=False,proxies=proxies1)
